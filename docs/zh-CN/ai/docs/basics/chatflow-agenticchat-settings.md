...
![Chatflow设置面板:Agent权限、预设问题(多语言)、缓存、对话端开关、会话变量与环境变量](./images/1.10-1-Chatflow%E8%AE%BE%E7%BD%AE.png)
...
![AgenticChat设置项:人机交互、待办事项、派生Subagent与Agent权限、简繁转换、允许Fork](./images/1.10-2-AgenticChat%E8%AE%BE%E7%BD%AE.png)
...
![Workflow设置面板:编辑权限、缓存、简繁转换与环境变量](./images/1.10-3-Workflow%E8%AE%BE%E7%BD%AE.png)
