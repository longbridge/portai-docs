---
layout: home
title: PortAI Babbage - 企业级金融智能 Agent 构建平台
description: PortAI Babbage 是 PortAI 旗下的 Agent Builder 平台，融合 SOTA 大模型接入、内置金融工具与多场景 Agent 构建能力，提供安全、可观测、可治理的智能 Agent 基础设施，助力 AI 在金融业务中的规模化落地。
head:
  - - meta
    - name: keywords
