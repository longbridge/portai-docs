...
> This guide was split out from the former "Technique 4" of [Mode and Model Selection Techniques](mode-model-selection).
...
The platform supports this natively: when creating a Skill, choose **Search Skill** to **search community Skills on GitHub online and import them directly** (see [Skill System - Three Creation Methods](../basics/capabilities/skill)); if no ready-made Skill turns up, follow the process below to adapt one yourself.
...
3. **Adapt**: restructure it in Skill style — conclusions first, actionable rules, examples attached (for writing guidance see [Prompt Writing Techniques](prompt-writing) and [Skill System](../basics/capabilities/skill)); remove tool instructions irrelevant to the platform, and for financial scenarios strip out stock-recommendation / return-promise content and add compliance red lines (see [Compliance Requirements](../compliance/index))
...
- [Skill System](../basics/capabilities/skill) — creating Skills (including search import), writing style, and attaching
- [Prompt Writing Techniques](prompt-writing) — Skill content follows the same writing principles as prompts
- [Compliance Requirements](../compliance/index) — content compliance for customer-facing Agents
