...
以下場景一經識別即不通過 (與 [合規要求](index)的六大原則一一對應):
...
2. **合規地實現同類需求**:很多"不通過"其實是表述問題 —— 比如想做指標分析 Agent，把"金叉買入提醒"改為"金叉形態的中立解讀"(描述性語言，見 [參考 Prompt](index)),即可合規上線
3. **已上架被下架的**:整改後可重新提交稽核

## 關聯閱讀

- [合規要求](index) — 參考 Prompt、紅線速查表與上線自查
- [Guardrail 安全護欄](../basics/capabilities/guardrail) — 稽核管"上線前",Guardrail 管"執行時"
- [Agent 使用範圍宣告](../basics/regions) — 廣場 Agent 僅供學習交流
