...
![Chatflow 設定面板:Agent 許可權、預設問題 (多語言)、快取、對話端開關、會話變數與環境變數](./images/1.10-1-Chatflow%E8%AE%BE%E7%BD%AE.png)
...
![Workflow 設定面板：編輯許可權、快取、簡繁轉換與環境變數](./images/1.10-3-Workflow%E8%AE%BE%E7%BD%AE.png)
